            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-flat" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <?php 
                        ...
                        $partner_permission = json_decode($partner_details[0]['permissions'],true);
                ...
                <!-- <li class="nav-item has-treeview ">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('waiter/waiter/manage_waiter/') ?>" class="nav-link">
                                <i class="fas fa-plus-square nav-icon"></i>
                                <p>Manage Waiter</p>
                            </a>
                        </li>
                ...
                <!-- <li class="nav-item has-treeview ">
                    <a href="#" class="nav-link menu-open">
                        <i class="nav-icon fas fa-utensils text-primary"></i>
                        <p>
                            Tables
                            <i class="right fas fa-angle-left"></i>
                        </p>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('partner/table_booking/manage_floore') ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('partner/table_booking/manage_table') ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('partner/table_booking/dine_in_customers') ?>" class="nav-link">
                                <i class="fas fa-users nav-icon"></i>
                                <p>Dine in Customers</p>
                            </a>
                        </li>
                    </ul>
                </li> -->
