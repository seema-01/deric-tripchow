                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/Payment_settings/update_payment_settings'); ?>" method="POST" id="payment_setting_form">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" name="phonepe_salt_index" value="<?= isset($settings['phonepe_salt_index']) && (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($settings['phonepe_salt_index']) - 3) . substr($settings['phonepe_salt_index'], -3) : @$settings['phonepe_salt_index'] ?>" placeholder="Salt index" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
