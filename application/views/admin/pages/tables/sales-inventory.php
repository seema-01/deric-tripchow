                                ...
                                <div class="row col-md-12">
                                    ...
                                    <!-- <div class="form-group col-md-4">
                                        <div>
                                            ...
                                            <select class='form-control' name='partner_ids' id="partner_ids search_partners_list">
                                    ...
                                    <div class="form-group col-md-4">
                                        <div>
                                            <label>Partner Name</label>
                                            <select class='form-control' name='partner_ids' id='partner_ids search_partners'>
                                                <option value="">Select partner</option>
                                                <?php foreach ($partners as $partner) { ?>
                                                    <option value="<?= $partner['partner_id'] ?>"><?= $partner['partner_name'] ?></option>
                                                <?php } ?>
