    ...
    function get_waiter_list()
    {
        ...
        foreach ($waiter_search_res as $row) {
            ...
            if ($this->ion_auth->is_partner()) {
                // $operate = ' <a href="javascript:void(0)" class="edit_btn btn btn-success btn-xs mr-1 mb-1" title="View" data-id="' . $row['floore_id'] . '" data-url="partner/table_booking/"><i class="fa fa-pen"></i></a>';
