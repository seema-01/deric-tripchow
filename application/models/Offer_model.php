...
class Offer_model extends CI_Model
{
    ...
    function get_offer_list()
    {
        ...
        foreach ($offer_search_res as $row) {
            ...
            // $tempRow['image'] = "<a href='" . $row['image_main'] . "' data-toggle='lightbox' data-gallery='gallery'> <img src='" . $row['image'] . "' class='h-25' width='" . $imageWidth . "' height='" . $imageHeight . "'></a>";
            // $tempRow['banner'] = "<a href='" . $row['banner'] . "' data-toggle='lightbox' data-gallery='gallery'> <img src='" . $row['banner'] . "' class='h-25' width='" . $bannerWidth . "' height='" . $bannerHeight . "'></a>";
