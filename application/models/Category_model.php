...
class Category_model extends CI_Model
{
    ...
    public function get_category_list()
    {
        ...
        foreach ($cat_search_res as $row) {
            ...
            // $tempRow['image'] = "<div class='image-box-100' ><a href='" . $row['image_main'] . "' data-toggle='lightbox' data-gallery='gallery'> <img src='" . $row['image'] . "' class='h-25' width='" . $imageWidth . "' height='" . $imageHeight . "'></a></div>";
            ...
            // $tempRow['banner'] = "<div class='center-image image-box-100'><a href='" . $row['banner_main'] . "' data-toggle='lightbox' data-gallery='gallery'> <img src='" . $row['banner'] . "' class='h-25' width='" . $bannerWidth . "' height='" . $bannerHeight . "'></a></div>";
