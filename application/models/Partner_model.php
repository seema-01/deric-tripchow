...
class Partner_model extends CI_Model
{
    ...
    function settle_partner_commission()
    {
        ...
        $data = $this->db->select(" o.id as order_id,date(o.date_added) as order_date,oi.product_variant_id,oi.partner_id,o.final_total,o.delivery_charge")
        ...
        foreach ($data as $row) {
            ...
            $transfer_amt = $row['final_total']  - $row['delivery_charge'] - $commission_amt;
        ...
        if ($wallet_updated == true) {
            ...
            foreach ($partner_ids as $partners_id) {
                ...
                $user_res = fetch_details(['id' => $partners_id], 'users', 'username,fcm_id,web_fcm_id,email');
    ...
    public function top_partners()
    {
        ...
        foreach ($total_sale as &$sale) {
            $sale['partner_name'] = stripslashes($sale['partner_name']);
