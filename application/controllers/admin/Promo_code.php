...
class Promo_code extends CI_Controller
{
    ...
    public function add_promo_code()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            // $this->form_validation->set_rules('promocode_type', 'Promocode Type', 'trim|required|xss_clean');
            // if($_POST['promocode_type'] == "partner"){
            //     $this->form_validation->set_rules('partners[]', 'partners', 'trim|required|xss_clean');
