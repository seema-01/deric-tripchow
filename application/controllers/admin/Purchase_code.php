...
class Purchase_code extends CI_Controller
{
    ...
    public function validator()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
             ...
             $this->form_validation->set_rules('purchase_code_app', 'Purchase Code App', 'trim|xss_clean');
             $this->form_validation->set_rules('purchase_code_web', 'Purchase Code Web', 'trim|xss_clean');
             if (!isset($_POST['purchase_code_app']) || empty($_POST['purchase_code_app']) && !isset($_POST['purchase_code_web']) || empty($_POST['purchase_code_web'])) {
            if(empty($_POST['purchase_code_app']) || empty($_POST['purchase_code_web'])) {
                $this->response['error'] = true;
                $this->response['csrfName'] = $this->security->get_csrf_token_name();
                $this->response['csrfHash'] = $this->security->get_csrf_hash();
                $this->response['message'] = "Please enter valid purchase code !";
             ...
             if (!$this->form_validation->run()) {
                 ...
                 $this->response['messages'] = array(
                     'purchase_code_app' => form_error('purchase_code_app'),
                     'purchase_code_web' => form_error('purchase_code_web'),
                 );
                 print_r(json_encode($this->response));
             } else {
