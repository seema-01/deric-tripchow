        ...
        */
        ...
        if (!$this->form_validation->run()) {
            ...
            if ($type == "system_settings") {
                ...
                // $authentication_settings = json_decode($settings_res['authentication_settings'][0],true);
                // unset($settings_res['authentication_settings']);
                // $settings_res['authentication_method'] = ($authentication_settings['authentication_method'] == 'sms') ? 1 : 0;
